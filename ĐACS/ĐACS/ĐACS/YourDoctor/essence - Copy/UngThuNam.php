...
<head>
    ...
    <!-- Title  -->
    <title>Xét Nghiệm Ung Thư ở Nam</title>
    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_thumb clearfix">
            <div class="product_thumbnail_slides owl-carousel">
                <img src="img/product-img/BS.jpg"width="20%" alt="">
                <img src="img/product-img/BS5.jpg" alt="">
        ...
        <div class="single_product_desc clearfix">
            ...
            <a href="UngThuNam.php">
                <h2>Tầm Soát Ung Thư Nam</h2>
            </a>
            <p>
            ...
            <p class="product-price"><span class="old-price"></span>1.190.000đ</p>
