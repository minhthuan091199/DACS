...
<body>
                                    ...
                                    <ul class="single-mega cn-col-4">
                                        <div style="background-color: #33ccff;">
                                            <li class="title"style="font-size:15px"><img src="img/core-img/HoiDaps.png"width="40px" alt=""><b>Hỏi đáp
                                                ...
                                                <li><a href="hoidap.php" style="font-size: 15px;font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;"><b>Hỏi Đáp Với Bác Sĩ</b></a></li>
        ...
        <div class="cart-content d-flex">
            ...
            <div class="cart-amount-summary">
                ...
                <div class="checkout-btn mt-100">
                    <a href="HoaDon.html" class="btn essence-btn">Đặt lịch hẹn</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_thumb clearfix">
                <img src="img/product-img/BS2.jpg"width="100%" alt="">
        ...
        <div class="single_product_desc clearfix">
            ...
            <form class="cart-form clearfix" method="post">
                ...
                <div class="cart-fav-box d-flex align-items-center">
                    ...
                    <button onclick="location.href='HoaDon.php?id=1'" type="button">
                        Đặt Lịch Hẹn</button>
