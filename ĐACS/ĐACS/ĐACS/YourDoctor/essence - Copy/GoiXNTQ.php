...
<head>
    ...
    <!-- Title  -->
    <title>Gói Xét Nghiệm Tổng Quát</title>
        ...
        <div class="cart-content d-flex">
            ...
            <div class="cart-amount-summary">
                ...
                <div class="checkout-btn mt-100">
                    <a href="HoaDon.php" class="btn essence-btn">Đặt lịch hẹn</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_thumb clearfix">
            <div class="product_thumbnail_slides owl-carousel">
                <img src="img/product-img/BSS9.jpg"width="20%" alt="">
                <img src="img/product-img/BSs7.jpg" alt="">
        ...
        <div class="single_product_desc clearfix">
            ...
            <a href="GoiXNTQ.php">
                <h2>Gói Xét Nghiệm Tổng Quát</h2>
            </a>
            <p>
            ...
            <p class="product-price"><span class="old-price"></span>850.000đ</p>
