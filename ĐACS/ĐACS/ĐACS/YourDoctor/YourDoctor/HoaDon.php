...
<head>
    ...
    <!-- Favicon  -->
    <link rel="icon" href="img/core-img/logomedial.png"width="40px">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="page-title text-center">
                        <h2>Phiếu Thông Tin Thanh Toán</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="checkout_area section-padding-80">
        <div class="container">
            ...
            <?php
                        ...
                        $query = "SELECT * FROM dichvu Where ID = ". $_GET['id'];
                        ...
                        if ($result = $mysqli->query($query)) {
                            ...
                            ?>
            <form action="ThanhToanTC.php" method="POST">
                        ...
                        <div class="cart-page-heading mb-30">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="last_name"> Họ vàTên <span>*</span></label>
                                    <input type="text"  name="name"  class="form-control" id="last_name" value="" required>
                                </div>
                                ...
                                <div class="col-12 mb-3">
                                    <label for="country">Khu Vực <span>*</span></label>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input name='street_address' type="text" class="form-control mb-3" id="street_address" value="">
                                </div>
                                
                                <div class="col-12 mb-3">
                                    <label for="phone_number">SDT <span>*</span></label>
                                    <input name='phone_number' type="text" class="form-control" id="phone_number" min="0" value="">
                                </div>
                                <div class="col-12 mb-4">
                                    <label for="email_address">Địa Chỉ Email <span>*</span></label>
                                    <input name='email_address' type="email" class="form-control" id="email_address" value="">
                                </div>
                                <div class="col-12 mb-4">
                                    <label for="date">Lich <span>*</span></label>
                                    <input name='date' type="date" class="form-control" id="email_address" value="">
                                </div>
                ...
                <div class="" >
                    <div class="order-details-confirmation" >
                        ...
                        <ul class="order-details-form mb-4">
                            <li><span> <?php echo $row['DichVu']; ?></li>
                            
                            
                            <li><span>Tổng</span> <span><?php echo $row['DonGia']; ?></span></li>
                        </ul>
                        <input name='DichVu' type="hidden" value = '<?php echo $row['DichVu']; ?>' >
                        <input name='Tong' type="hidden" value = <?php echo $row['DonGia']; ?>> 

                        <input type='submit' value='Thanh Toán' class="btn essence-btn" >
                    </div>
                </div>
            </form>
            <?php
