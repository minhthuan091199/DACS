...
<head>
    ...
    <!-- Title  -->
    <title>Chăm Sóc Tại Nhà Toàn Diện</title>
    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_thumb clearfix">
            <div class="product_thumbnail_slides owl-carousel">
                <img src="img/product-img/BSS1.jpg"width="20%" alt="">
                <img src="img/product-img/BSS2.jpg" alt="">
        ...
        <div class="single_product_desc clearfix">
            ...
            <a href="CSTNTD.php">
                <h2>Chăm Sóc Tại Nhà Toàn Diện</h2>
            </a>
            <p>
                <strong>Nội Dung Xét Nghiệm</strong>
            </p>
            <p style="padding-left: 30px;color: crimson;">
                <!--if sp list -->
                1.&nbsp;&nbsp;&nbsp;
                "Thay Băng Vết Thương Sạch <= 15cm - Giá :  250.000đ "
            </p>
            <p style="padding-left: 30px;color: crimson;">
                <!--if sp list -->
                2.&nbsp;&nbsp;&nbsp;
                "Thay Băng Vết Thương Sạch >= 15cm - Giá :  300.000đ "
            </p>
            <p style="padding-left: 30px;color: crimson;">
                <!--if sp list -->
                3.&nbsp;&nbsp;&nbsp;
                "Thay Băng Đa Vết Thương - Giá : 350.000đ"
            </p>
            <p style="padding-left: 30px;color: crimson;">
                <!--if sp list -->
                4.&nbsp;&nbsp;&nbsp;
                "Thay Băng Vết Thương Nhiễm Trùng : 400.000đ"
            </p>
            ...
            <p class="product-desc">Bước 1: Điều dưỡng eDoctor đến tận nhà để lấy mẫu xét nghiệm và chuyển đến Trung tâm Y Khoa Medic – Hòa Hảo để tiến hành các phân tích.
               ...
               <br> Bước 2: Kết quả phân tích sẽ được trả về tài khoản bệnh nhân thông qua hệ thống YourDocTor tại website và ứng dụng YourDocTor
                
                <br> Bước 3: Bác sĩ liên hệ giải thích và tư vấn kết quả xét nghiệm qua điện thoại.</p>
            ...
            <form class="cart-form clearfix" method="post">
                ...
                <div class="select-box d-flex mt-50 mb-30">
                    <select name="select" id="productSize" class="mr-5">
                        <option value="value">Chọn Khu Vực</option>
                        <option value="value">Thành Phố Hồ Chí Minh</option>
                        <option value="value">Bình Dương</option>
                        <option value="value">Vũng Tàu</option>
                    </select>
                    
                        <input type="text" name="" placeholder="Tên Khách Hàng"> <br>
                        <input type="text" name="" placeholder="Gmail">
                        <input type="text" name="" placeholder="SDT">
                    
                </div>
                <!-- Cart & Favourite Box -->
                <div class="cart-fav-box d-flex align-items-center">
                    <!-- Cart -->
                    <button onclick="location.href='HoaDon.php'" type="button">
                        Đặt Lịch Hẹn</button>
                    <!-- Favourite -->
