...
<head>
    ...
    <!-- Title  -->
    <title>Xét Nghiệm Ung Thư ở Nữ</title>
...
<body>
    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_desc clearfix">
            ...
            <a href="XetNghiemUngThuNu.php">
                <h2>Tầm Soát Ung Thư Nữ</h2>
            </a>
            <p>
            ...
            <p style="padding-left: 30px;">
                <!--if sp list -->
                1.&nbsp;&nbsp;&nbsp;
                "CA 12.5: Dấu ấn ung buồng trứng."
            </p>
            <p style="padding-left: 30px;">
                <!--if sp list -->
                2.&nbsp;&nbsp;&nbsp;
            ...
            <p style="padding-left: 30px;">
                <!--if sp list -->
                3.&nbsp;&nbsp;&nbsp;
                "Cyfra 21.1: Dấu ấn ung thư phổi không tế bào nhỏ."
            </p>
            <p style="padding-left: 30px;">
                <!--if sp list -->
                4.&nbsp;&nbsp;&nbsp;
            ...
            <p class="product-price"><span class="old-price"></span>800.000đ</p>
