...
<head>
    ...
    <!-- Title  -->
    <title>Gói Khám Sức Khỏe Cơ Bản</title>
    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_thumb clearfix">
            <div class="product_thumbnail_slides owl-carousel">
                <img src="img/product-img/BS8.jpg"width="20%" alt="">
                <img src="img/product-img/BS10.jpg" alt="">
        ...
        <div class="single_product_desc clearfix">
            ...
            <a href="TongQuatCB.php">
                <h2>Gói khám Sức Khỏe Cơ Bản</h2>
            </a>
            <p>
            ...
            <p class="product-price"><span class="old-price"></span>1.490.000đ</p>
