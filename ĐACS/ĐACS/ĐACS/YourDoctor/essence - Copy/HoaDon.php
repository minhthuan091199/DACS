                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <select class="w-100" id="country">
                                        <option value="usa">Thành Phố Hồ Chí Minh</option>
                                        <option value="uk">Bình Dương</option>
                                        <option value="ger">Vũng Tàu</option>
                                ...
                                <div class="col-12">
                                    <div class="custom-control custom-checkbox d-block mb-2">
                                        ...
                                        <label class="custom-control-label" for="customCheck1">Điều Khoản Dịch Vụ</label>
                                    </div>
                                    <div class="custom-control custom-checkbox d-block mb-2">
                ...
                <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                    <div class="order-details-confirmation">
                        ...
                        <ul class="order-details-form mb-4">
                            ...
                            <li><span>Gói Khám Tổng Quát</span> <span>SL : 1</span></li>
                            <li><span>Giá</span> <span>850.000đ</span></li>
                            <li><span>Phí Dịch Vụ Thêm</span> <span>Free</span></li>
                            <li><span>Tổng</span> <span>850.000đ</span></li>
                        </ul>
                        ...
                        <a href="PhatTrien.php" class="btn essence-btn">Thanh Toán</a>
                    </div>
                </div>
            </div>
        </div>
