...
<body>
    ...
    <?php
                        ...
                        $query = "SELECT * FROM chitietkhoa Where ID = ". $_GET['id'];
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="page-title text-center">
                        <h2 style="background:cornsilk;color: blue;height: 100px;font-size: 70px;"><?php echo $row['TenKhoa'] ; ?></h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="single-blog-content-wrapper d-flex">
            ...
            <div class="related-blog-post">
                ...
                <div class="single-related-blog-post">
                    <img src="img/product-img/abc.jpg" alt="">
                    <a href="#">
                        <h5 style="font-size: 45px;">Khoa Hô Hấp</h5>
                    </a>
                </div>
                <!-- Single Related Blog Post -->
                <div class="single-related-blog-post">
                    <img src="img/product-img/abcde.jpg" alt="">
                    <a href="#">
                        <h5 style="font-size: 45px;padding-left: 50px;">Khoa Sản</h5>
                    </a>
                </div>
                <!-- Single Related Blog Post -->
                <div class="single-related-blog-post">
                    <img src="img/product-img/abcdef.jpg" alt="">
                    <a href="#">
                        <h5 style="padding-left: 50px;font-size: 45px;">Khoa Tai Mũi Họng</h5>
                    </a>
                </div>
                <!-- Single Related Blog Post -->
                <div class="single-related-blog-post">
                    <img src="img/product-img/abcdefgh.jpg" alt="">
                    <a href="#">
                        <h5 style="font-size: 45px;padding-left: 50px;">Khoa Tim Mạch</h5>
                    </a>
                </div>
            </div>
